...
same IP address.  So make sure the standalone shairport-sync addon is stopped
and uninstalled.

Ports 319/320 must not be in use by anything else on the HA host. If another
PTP service is using them NQPTP will fail to start.
...
## Links
- [LedFX Home](https://docs.ledfx.app/en/latest/index.html)
- [LedFX github](https://github.com/LedFx/LedFx)
- [airglow](https://github.com/RoyalPineapple/airglow)
